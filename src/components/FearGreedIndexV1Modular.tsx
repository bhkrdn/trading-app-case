...
export interface FearGreedIndexV1ModularProps {
  value?: number;
  label?: string;
  description?: string;
}

export const FearGreedIndexV1Modular: React.FC<FearGreedIndexV1ModularProps> = ({
  value = 78,
...
export default FearGreedIndexV1Modular; 